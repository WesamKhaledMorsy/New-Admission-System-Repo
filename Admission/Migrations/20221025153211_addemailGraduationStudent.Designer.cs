...
namespace Admission.Migrations
{
    ...
    [Migration("20221025153211_addemailGraduationStudent")]
    partial class addemailGraduationStudent
    {
            ...
            modelBuilder.Entity("Admission.Model.DomainModel.Student", b =>
                {
                    ...
                    b.HasOne("Admission.Model.DomainModel.Interviewer", null)
                        .WithMany("Student")
                        .HasForeignKey("InterviewerId");
                    ...
                    b.HasOne("Admission.Model.DomainModel.University", null)
                        .WithMany("Students")
